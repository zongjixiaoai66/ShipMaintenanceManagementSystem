               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="船家编号" prop="chuanjiaUuidNumber">
                       <el-input v-model="ruleForm.chuanjiaUuidNumber"
                                 placeholder="船家编号" clearable  :readonly="ro.chuanjiaUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="船家姓名" prop="chuanjiaName">
                       <el-input v-model="ruleForm.chuanjiaName"
                                 placeholder="船家姓名" clearable  :readonly="ro.chuanjiaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="船家手机号" prop="chuanjiaPhone">
                       <el-input v-model="ruleForm.chuanjiaPhone"
                                 placeholder="船家手机号" clearable  :readonly="ro.chuanjiaPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="船家身份证号" prop="chuanjiaIdNumber">
                       <el-input v-model="ruleForm.chuanjiaIdNumber"
                                 placeholder="船家身份证号" clearable  :readonly="ro.chuanjiaIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="船家邮箱" prop="chuanjiaEmail">
                       <el-input v-model="ruleForm.chuanjiaEmail"
                                 placeholder="船家邮箱" clearable  :readonly="ro.chuanjiaEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    chuanjiaUuidNumber: true,
                    chuanjiaName: false,
                    chuanjiaPhone: false,
                    chuanjiaIdNumber: false,
                    chuanjiaPhoto: false,
                    sexTypes: false,
                    chuanjiaEmail: false,
                    jinyongTypes: false,
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    chuanjiaUuidNumber: new Date().getTime(),
                    chuanjiaName: '',
                    chuanjiaPhone: '',
                    chuanjiaIdNumber: '',
                    chuanjiaPhoto: '',
                ...
                rules: {
                   ...
                   chuanjiaUuidNumber: [
                              { required: true, message: '船家编号不能为空', trigger: 'blur' },
                          ],
                   chuanjiaName: [
                              { required: true, message: '船家姓名不能为空', trigger: 'blur' },
                          ],
                   chuanjiaPhone: [
                              {  required: true, message: '船家手机号不能为空', trigger: 'blur' },
                   ...
                   chuanjiaIdNumber: [
                              { required: true, message: '船家身份证号不能为空', trigger: 'blur' },
                   ...
                   chuanjiaPhoto: [
                              { required: true, message: '船家头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   chuanjiaEmail: [
                              { required: true, message: '船家邮箱不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chuanjia/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chuanjiaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
