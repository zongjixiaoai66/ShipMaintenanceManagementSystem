               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维保公司编号" prop="weibaogongsiUuidNumber">
                       <el-input v-model="ruleForm.weibaogongsiUuidNumber"
                                 placeholder="维保公司编号" clearable  :readonly="ro.weibaogongsiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维保公司名称" prop="weibaogongsiName">
                       <el-input v-model="ruleForm.weibaogongsiName"
                                 placeholder="维保公司名称" clearable  :readonly="ro.weibaogongsiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="负责人" prop="weibaogongsiFuzeren">
                       <el-input v-model="ruleForm.weibaogongsiFuzeren"
                                 placeholder="负责人" clearable  :readonly="ro.weibaogongsiFuzeren"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维保公司手机号" prop="weibaogongsiPhone">
                       <el-input v-model="ruleForm.weibaogongsiPhone"
                                 placeholder="维保公司手机号" clearable  :readonly="ro.weibaogongsiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司位置" prop="weibaogongsiAddress">
                       <el-input v-model="ruleForm.weibaogongsiAddress"
                                 placeholder="公司位置" clearable  :readonly="ro.weibaogongsiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    weibaogongsiUuidNumber: true,
                    weibaogongsiName: false,
                    weibaogongsiFuzeren: false,
                    weibaogongsiPhone: false,
                    weibaogongsiPhoto: false,
                    weibaogongsiAddress: false,
                    jinyongTypes: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    weibaogongsiUuidNumber: new Date().getTime(),
                    weibaogongsiName: '',
                    weibaogongsiFuzeren: '',
                    weibaogongsiPhone: '',
                    weibaogongsiPhoto: '',
                ...
                rules: {
                   ...
                   weibaogongsiUuidNumber: [
                              { required: true, message: '维保公司编号不能为空', trigger: 'blur' },
                          ],
                   weibaogongsiName: [
                              { required: true, message: '维保公司名称不能为空', trigger: 'blur' },
                          ],
                   weibaogongsiFuzeren: [
                              { required: true, message: '负责人不能为空', trigger: 'blur' },
                          ],
                   weibaogongsiPhone: [
                              {  required: true, message: '维保公司手机号不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`weibaogongsi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.weibaogongsiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
